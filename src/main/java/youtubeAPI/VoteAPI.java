...
public class VoteAPI extends Thread{
    ...
    private static NettyClient LocalServer = new NettyClient();
    ...
    public void run(){
        ...
        Map<String,String> tempVoteResult = new HashMap<String,String>();
        Map<String,Integer> tempVoteCount = new HashMap<String,Integer>();
    ...
    public static void sendVoteResult(){
        LocalServer.sendMsg(JSON.toJSONString(VoteResult));
    }

    public static void sendEnd(){
        LocalServer.sendMsg("VoteEnd");
    }
}
